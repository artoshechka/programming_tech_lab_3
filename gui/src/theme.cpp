...
#brandMark { background: #c0281a; border-radius: 0; }
...
QComboBox { background: #ffffff; border: 1px solid #e0dfdd; border-radius: 0; padding: 5px 12px; min-height: 24px; min-width: 70px; color: #2b2b30; combobox-popup: 0; }
QComboBox:hover { border-color: #c0281a; }
QComboBox::drop-down { border: none; width: 22px; }
QComboBox QAbstractItemView { background: #ffffff; border: 1px solid #e0dfdd; border-radius: 0;
    selection-background-color: #f6ddd8; selection-color: #8c1a0f; outline: 0; padding: 4px; }
QComboBox QAbstractItemView::item { min-height: 28px; padding: 4px 10px; border-radius: 0; color: #2b2b30; }
...
QPushButton#primaryButton { background: #c0281a; color: #ffffff; border: none; border-radius: 0; padding: 6px 16px; font-weight: 600; }
...
QToolButton#themeButton { background: #ffffff; border: 1px solid #e0dfdd; border-radius: 0; padding: 6px 12px; color: #2b2b30; }
QToolButton#themeButton:hover { border-color: #c0281a; color: #a41f12; }

QCheckBox { spacing: 8px; color: #2b2b30; font-weight: 500; }
QCheckBox::indicator { width: 16px; height: 16px; border: 1.5px solid #c9c8c6; border-radius: 0; background: #ffffff; }
...
QToolButton#paletteButton { background: #ffffff; border: 1px solid #e0dfdd; border-radius: 0; padding: 6px 12px; color: #2b2b30; font-weight: 500; }
...
#brandMark { background: #d44530; border-radius: 0; }
...
QComboBox { background: #34343b; border: 1px solid #44444e; border-radius: 0; padding: 5px 12px; min-height: 24px; min-width: 70px; color: #ececee; combobox-popup: 0; }
QComboBox:hover { border-color: #d44530; }
QComboBox::drop-down { border: none; width: 22px; }
QComboBox QAbstractItemView { background: #2e2e34; border: 1px solid #44444e; border-radius: 0;
    selection-background-color: #4d211a; selection-color: #f5b6a8; outline: 0; padding: 4px; color: #ececee; }
QComboBox QAbstractItemView::item { min-height: 28px; padding: 4px 10px; border-radius: 0; color: #ececee; }
...
QPushButton#primaryButton { background: #d44530; color: #1a1a1e; border: none; border-radius: 0; padding: 6px 16px; font-weight: 600; }
...
QToolButton#themeButton { background: #34343b; border: 1px solid #44444e; border-radius: 0; padding: 6px 12px; color: #ececee; }
QToolButton#themeButton:hover { border-color: #d44530; color: #f5b6a8; }

QCheckBox { spacing: 8px; color: #ececee; font-weight: 500; }
QCheckBox::indicator { width: 16px; height: 16px; border: 1.5px solid #55555f; border-radius: 0; background: #34343b; }
...
QToolButton#paletteButton { background: #34343b; border: 1px solid #44444e; border-radius: 0; padding: 6px 12px; color: #ececee; font-weight: 500; }
